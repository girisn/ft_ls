...
#./ft_ls -l /dev | grep -v "ls:" | grep -v "loop-control" |grep -v "dtrace" | grep -v "io8log" | grep -v "io8logtemp" > .result/r1 2>&1;
#ls -l /dev | grep -v "ls:" | grep -v "loop-control" | grep -v "dtrace" | grep -v "io8log" | grep -v "io8logtemp" > .result/r2 2>&1;
